...
/** Schemastery configuration for the mem-enhance consumer. */
...
export function apply(ctx: Context, config: Config): void {
  ...
  try {
    ...
    ctx.logger.warn(`mem-enhance: cannot open memory store at ${dbPath}: ${String(error)}; memory features disabled`)
    return
  }
