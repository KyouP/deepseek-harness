// packages/dsh-mem-enhance/tests/integration.spec.ts
// Whole-mount smoke: the dsh-mem-enhance plugin over the real SystemPrompt +
...
describe('dsh-mem-enhance integration', () => {
